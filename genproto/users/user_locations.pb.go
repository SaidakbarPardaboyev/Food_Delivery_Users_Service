...
var file_user_locations_proto_rawDesc = []byte{
	...
	0x75, 0x64, 0x65, 0x32, 0xd8, 0x02, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x63, 0x61,
	...
	0x79, 0x1a, 0x0b, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x42, 0x10,
...
var file_user_locations_proto_depIdxs = []int32{
	...
	1, // 7: users.UserLocationService.Create:output_type -> users.UserLocation
	1, // 8: users.UserLocationService.GetById:output_type -> users.UserLocation
	1, // 9: users.UserLocationService.GetByUserId:output_type -> users.UserLocation
	3, // 10: users.UserLocationService.GetAll:output_type -> users.UserLocations
	1, // 11: users.UserLocationService.Update:output_type -> users.UserLocation
	6, // 12: users.UserLocationService.Delete:output_type -> users.Void
